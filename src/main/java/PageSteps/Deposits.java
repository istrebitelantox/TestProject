...
public class Deposits {
    ...
    public final A btnShowRates =new A("@id='btn-show-rates'");
    ...
    public final A acceptInstantDepositAgreementButton =new A("@id='accept-instant-deposit-agreement-button'");
